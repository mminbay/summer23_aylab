...
'''
The classes defined here are used for sharing memory across different processes without actually copying data.
If this ends up working, you future generations will owe me big time for how much time this saves you.
'''
